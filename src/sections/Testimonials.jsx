		...
		>
			<div className="flex flex-row items-center gap-2">
				...
				<div className="flex flex-col">
					...
					<p className="text-xs font-medium ftext-white/40">{username}</p>
				</div>
			</div>
...
export default function Testimonials() {
	return (
		<div className="c-space section-spacing items-start mt-25 md:mt-35 ">
      <h2 className="text-heading capitalize">people who worked with me</h2>
